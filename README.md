...
2021-12-22  | 第十章：数组和指针：函数、数组和指针，指针操作，保护数组中的数据，const的其他内容，指针和多维数组，变长数组VLAN，复合字面量，关键概念，本章小结。<br>第十一章：字符串和字符串函数：字符串和字符串IO，输入，输出，自定义输入输出，字符串函数，字符串排序，字符函数和字符串，命令行参数，把字符串转换为数字，关键概念，本章小结。<br>第十二章：存储类别、连接和内存管理：
<br>
<br>
